...
function Hero2DFallback() {
  return (
    <div className="w-full h-full flex items-center justify-center pointer-events-none opacity-40">
      <div className="w-96 h-96 rounded-full border border-indigo-500/20 dark:border-cyan-500/20 bg-indigo-500/5 dark:bg-cyan-500/5 flex items-center justify-center relative">
        <div className="w-72 h-72 rounded-full border border-dashed border-indigo-400/20 dark:border-cyan-400/20" />
        <div className="w-48 h-48 rounded-full border border-indigo-400/30 dark:border-cyan-400/30 flex items-center justify-center bg-indigo-400/5 dark:bg-cyan-400/5">
          <Sparkles className="w-10 h-10 text-indigo-500/40 dark:text-cyan-400/40" />
        </div>
      </div>
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 mb-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 font-mono text-xs">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full font-medium bg-white/85 dark:bg-[#111622]/85 text-slate-700 dark:text-slate-300 border border-slate-200/80 dark:border-slate-800/80 shadow-xs backdrop-blur-sm">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-heading font-black tracking-tight text-slate-900 dark:text-white leading-[1.12] drop-shadow-xs dark:drop-shadow-[0_2px_20px_rgba(0,0,0,0.85)]">
            ...
            <span className="text-indigo-600 dark:text-cyan-400 drop-shadow-[0_0_20px_rgba(99,102,241,0.25)] dark:drop-shadow-[0_0_24px_rgba(0,229,255,0.35)]">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
            <InteractiveButton
              onClick={onStartDemo}
              className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white dark:bg-cyan-400 dark:hover:bg-cyan-300 dark:text-slate-950 font-heading font-black text-sm shadow-lg shadow-indigo-500/25 dark:shadow-cyan-500/25 group"
            >
              <Sparkles className="w-4 h-4 text-white dark:text-slate-950" />
              <span>Launch Trimodal Studio</span>
              <ArrowRight className="w-4 h-4 text-white dark:text-slate-950 group-hover:translate-x-1 transition-transform duration-200" />
            </InteractiveButton>

            <div className="text-xs font-mono text-slate-600 dark:text-slate-400 flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/80 dark:bg-[#080B10]/70 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <SpotlightCard 
            ...
            className="p-6 cursor-pointer group border border-slate-200/80 dark:border-slate-800/80 hover:border-indigo-200 dark:hover:border-slate-700 bg-white/80 dark:bg-[#0F141F]/75 backdrop-blur-md"
          >
            ...
            <h3 className="font-heading font-bold text-slate-900 dark:text-white text-base mb-1.5 group-hover:text-indigo-600 dark:group-hover:text-cyan-400 transition-colors">
              Facial Action Units
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 leading-relaxed">
              ResNet-18 vision encoder extracting 512-dim facial expressions with automated Haar cascade face cropping.
            </p>
            <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-600 dark:text-slate-400 group-hover:text-indigo-600 dark:group-hover:text-cyan-400 transition-colors">
